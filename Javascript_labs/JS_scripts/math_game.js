  ...
  submitBtn.addEventListener("click", () => {
    ...
    if (userInput) {
      ...
      if (userInput == answerValue) {
        ...
        stopGame(`Congratulations! <span>Correct</span> Answer`);
      }
      ...
      //If user guessed wrong answer
        ...
        stopGame(`Sorry! <span>Wrong</span> Answer`);
      }
    }
    ...
    var s = `Amount of answers is ${correctCount} / ${fullCount}`;
    document.getElementById("full").value = s;
  });
};
